...
install.packages("cagedExplorer")
...
snis_subset_agua <- snis_agua %>% 
  select(municipio_clean,
         tarifa_media_agua = in_005_tarifa_media_de_agua,
         perdas_agua = in_013_indice_de_perdas_faturamento,
         atendimento_agua = in_055_indice_de_atendimento_total_de_agua,
         consumo_medio_per_capita_agua = in_022_consumo_medio_percapita_de_agua,
         investimento_per_capita = inv_per_capita,
         desempenho_financeiro = in_012_indicador_de_desempenho_financeiro
  )

# Sewage-related features
snis_subset_esgoto <- snis_esgoto %>% 
  select(municipio_clean,
         tarifa_media_esgoto = in_006_tarifa_media_de_esgoto,
         coleta_esgoto = in_015_indice_de_coleta_de_esgoto,
         tratamento_esgoto = in_016_indice_de_tratamento_de_esgoto,
  )
